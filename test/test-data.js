const testCases = [
  ...
  },
  {
    ...
    expected: '<ref>{{Cite web |title=עניין אישי והפעם עם הדסה בן ארי |url=https://www.inn.co.il/news/312182 |author=רבקי גולדפינגר |date=15 December 2015 |website=[[Arutz Sheva]] |language=he}}</ref>'
  },
  {
  ...
  {
    input: '{{הערה|1={{הארץ|אור קשתי|משרד החינוך התלונן במשטרה נגד חרדים אשכנזים שנמנעים מלשלוח את בנותיהם ללמוד עם מזרחיות|1.1192186|7 במרץ 2010}}}}',
    expected: '<ref>{{Cite web |title=משרד החינוך התלונן במשטרה נגד חרדים אשכנזים שנמנעים מלשלוח את בנותיהם ללמוד עם מזרחיות |url=https://www.haaretz.co.il/news/politics/2011-09-12/ty-article/1.1192186 |author=אור קשתי |date=7 March 2010 |website=[[Haaretz]] |language=he}}</ref>'
  }
];